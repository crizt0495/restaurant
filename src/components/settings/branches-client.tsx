...
export function BranchesClient({ branches, canEdit }: BranchesClientProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Cabang</h2>
        <p className="mt-1.5 text-sm font-medium text-muted-foreground">Kelola cabang restoran</p>
      </div>
