...
export function CustomersReport({ customers, totalSpent, memberCount }: CustomersReportProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Laporan Pelanggan</h2>
        <p className="mt-1.5 text-sm font-medium text-muted-foreground">Performa pelanggan dan loyalitas</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(customers.length)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Anggota</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(memberCount)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Total Pendapatan dari Pelanggan</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(totalSpent)}</p>
          </CardContent>
        </Card>
      </div>
