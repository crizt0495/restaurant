...
export function ProfitReport({ summary }: ProfitReportProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Laba Rugi</h2>
        <p className="mt-1.5 text-sm font-medium text-muted-foreground">Ringkasan laba rugi periode</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(summary.revenue)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Laba Kotor</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(summary.grossProfit)}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(summary.netProfit)}</p>
