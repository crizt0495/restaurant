...
export function SalesReport({ summary, dailySales, paymentBreakdown }: SalesReportProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Laporan Penjualan</h2>
        <p className="mt-1.5 text-sm font-medium text-muted-foreground">Ringkasan penjualan periode</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(summary.totalSales)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Orders</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(summary.orderCount)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Total Item</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(summary.totalItems)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Rata-rata Pesanan</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(summary.avgOrder)}</p>
          </CardContent>
        </Card>
      </div>
