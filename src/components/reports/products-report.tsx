...
export function ProductsReport({ products, dateFrom, dateTo }: ProductsReportProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Laporan Produk</h2>
        <p className="mt-1.5 text-sm font-medium text-muted-foreground">Produk terlaris dan performa</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(totalRevenue)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Total Item Terjual</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(totalQty)}</p>
          </CardContent>
        </Card>
      </div>
