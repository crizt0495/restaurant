...
export function InventoryReport({ items, totalStockValue }: InventoryReportProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Laporan Persediaan</h2>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatCurrency(totalStockValue)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Total Item</p>
            <p className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">{formatNumber(items.length)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Item Stok Rendah</p>
            <p className="font-display text-3xl font-bold text-destructive leading-none">
