  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Pelanggan</h2>
          <p className="mt-1.5 text-sm font-medium text-muted-foreground">Kelola data customer &amp; loyalty</p>
        </div>
        {canCreate && (
      ...
      <Dialog open={rewardDialog} onOpenChange={setRewardDialog}>
        <DialogContent>
          ...
          {rewardCustomer && (
            <div className="space-y-4">
              <div className="rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 to-accent/10 p-4">
                <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Poin tersedia</p>
                <p className="tabular mt-1 font-display text-3xl font-bold leading-none text-primary">{Number(rewardCustomer.points || 0).toLocaleString("id-ID")}</p>
                <p className="mt-1 text-sm text-muted-foreground">{rewardCustomer.name}</p>
              </div>
              <div className="grid gap-2">
