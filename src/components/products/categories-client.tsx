  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-display text-2xl font-bold tracking-tight md:text-3xl leading-none">Kategori</h2>
          <p className="mt-1.5 text-sm font-medium text-muted-foreground">Manajemen kategori produk</p>
        </div>
