...
insert into products (id, organization_id, category_id, name, sku, barcode, description, selling_price, purchase_price, cost_price, tax_percentage, unit, stock_tracking, minimum_stock, is_active, is_favorite, has_variants) values
  ...
  ('30000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'Es Teh', 'BV-001', '899123400007', 'Es teh manis segar', 5000, 1500, 1000, 11, 'gelas', true, 20, true, true, false),
  ('30000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'Teh Hangat', 'BV-002', '899123400008', 'Teh hangat manis', 4000, 1200, 800, 11, 'gelas', true, 20, true, false, false),
  ('30000000-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'Es Jeruk', 'BV-003', '899123400009', 'Es jeruk peras segar', 8000, 2500, 2000, 11, 'gelas', true, 20, true, true, false),
  ('30000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'Kopi Hitam', 'CF-001', '899123400010', 'Kopi hitam klasik', 15000, 3000, 2500, 11, 'cup', true, 30, true, true, false),
  ('30000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'Cappuccino', 'CF-002', '899123400011', 'Cappuccino dengan foam susu', 20000, 5000, 4000, 11, 'cup', true, 20, true, true, false),
  ('30000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'Latte', 'CF-003', '899123400012', 'Espresso dengan susu steamed', 22000, 6000, 5000, 11, 'cup', true, 20, true, true, false),
  ('30000000-0000-0000-0000-000000000013', '00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'Pisang Goreng', 'DS-001', '899123400013', 'Pisang goreng crispy dengan madu', 12000, 4000, 3500, 11, 'porsi', true, 15, true, false, false),
  ('30000000-0000-0000-0000-000000000014', '00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'Pudding', 'DS-002', '899123400014', 'Pudding vanilla dengan saus karamel', 10000, 3000, 2500, 11, 'cup', true, 15, true, false, false),
  ('30000000-0000-0000-0000-000000000015', '00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'Ice Cream', 'DS-003', '899123400015', 'Ice cream vanilla/chocolate', 15000, 5000, 4000, 11, 'scoop', true, 20, true, false, false);
